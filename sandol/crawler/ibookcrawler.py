...
class BookTranslator:
    """ibookDownloader.py에서 다운로드한 'data.xlsx'을 토대로 TIP, E동 식당의 식당 정보를 포함한 객체를 반환한다."""
    ...
    def tip_save_menu(self, weekday):
        ...
        self.tip_lunch_menu = list(
            self.df.iloc[6:12, weekday]
        )  # data.xlsx file 내 1열 8행~13행

...
BLOCK_IDS = {
    ...
    "modificate_menu": "67218142369c0a05baca376c",
...
CAFETRIA_REGISTER_QUICK_REPLY_LIST = [
    ...
    QuickReply(
        "점심 메뉴 추가", ActionEnum.BLOCK, block_id=BLOCK_IDS["add_lunch_menu"]
    ),
    QuickReply(
        "저녁 메뉴 추가", ActionEnum.BLOCK, block_id=BLOCK_IDS["add_dinner_menu"]
    ),
    QuickReply("메뉴 수정", ActionEnum.BLOCK, block_id=BLOCK_IDS["modificate_menu"]),
]
